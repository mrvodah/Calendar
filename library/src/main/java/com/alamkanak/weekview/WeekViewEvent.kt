...
open class WeekViewEvent {
    ...
    override fun toString(): String {
        ...
        val startTimeStr = WeekViewUtil.calendarToString(startTime, true)
        if (isAllDay) {
            if (WeekViewUtil.isSameDay(startTime, endTime))
        ...
        return "normalEvent(id=$id, startTime=$startTimeStr, endTime=$endTimeStr, name=$name, location=$location, color=$colorStr , shader=$shader)"
    }
}
